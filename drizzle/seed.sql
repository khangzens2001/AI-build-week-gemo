...
DELETE FROM mentors;
INSERT INTO mentors (id, name, title, org, bio, avatar_url, expertise, slots, source_url) VALUES ('mentor-vu-tien-hung', 'Vu Tien Hung', 'Senior Manager, Enterprise Sector, BytePlus', 'BytePlus', 'Senior Manager, Enterprise Sector, BytePlus', NULL, '["ai","backend","cloud"]', '[]', 'https://agenticaibuildweek.genaifund.ai/#daily_schedule');
INSERT INTO mentors (id, name, title, org, bio, avatar_url, expertise, slots, source_url) VALUES ('mentor-lam-thao', 'Lam Thao', 'Solution Architect, BytePlus', 'BytePlus', 'Solution Architect, BytePlus', NULL, '["ai","cloud"]', '[]', 'https://agenticaibuildweek.genaifund.ai/#daily_schedule');
INSERT INTO mentors (id, name, title, org, bio, avatar_url, expertise, slots, source_url) VALUES ('mentor-tran-quoc-huy', 'Tran Quoc Huy', 'Enterprise Sales Manager, BytePlus', 'BytePlus', 'Enterprise Sales Manager, BytePlus', NULL, '["ai","backend","cloud"]', '[]', 'https://agenticaibuildweek.genaifund.ai/#daily_schedule');
INSERT INTO mentors (id, name, title, org, bio, avatar_url, expertise, slots, source_url) VALUES ('mentor-jason-pham', 'Jason Pham', 'NVIDIA Inception Community Manager, Southeast Asia', 'NVIDIA', 'NVIDIA Inception Community Manager, Southeast Asia', NULL, '["ai","cloud","developer-tools","startup"]', '[]', 'https://agenticaibuildweek.genaifund.ai/#daily_schedule');
INSERT INTO mentors (id, name, title, org, bio, avatar_url, expertise, slots, source_url) VALUES ('mentor-rita-huang', 'Rita Huang', 'Product Operations Manager, TRAE', 'TRAE', 'Product Operations Manager, TRAE', NULL, '["product","developer-tools"]', '[]', 'https://agenticaibuildweek.genaifund.ai/#daily_schedule');
INSERT INTO mentors (id, name, title, org, bio, avatar_url, expertise, slots, source_url) VALUES ('mentor-saurav-jain', 'Saurav Jain', 'Senior Developer Community Manager, Apify', 'Apify', 'Senior Developer Community Manager, Apify', NULL, '["ai","agents","backend","infra","design"]', '[]', 'https://agenticaibuildweek.genaifund.ai/#daily_schedule');
INSERT INTO mentors (id, name, title, org, bio, avatar_url, expertise, slots, source_url) VALUES ('mentor-jakub-drobnik', 'Jakub Drobnik', 'Engineering Team Lead, Apify', 'Apify', 'Engineering Team Lead, Apify', NULL, '["ai","agents","backend","infra","design"]', '[]', 'https://agenticaibuildweek.genaifund.ai/#daily_schedule');
INSERT INTO mentors (id, name, title, org, bio, avatar_url, expertise, slots, source_url) VALUES ('mentor-linh-nguyen', 'Linh Nguyen', 'Google Developer Expert (AI/ML) & Head of AI at Obello.', 'Google Developer Experts', 'Google Developer Expert (AI/ML) & Head of AI at Obello.', NULL, '["ai","agents","backend","design","developer-tools"]', '[]', 'https://agenticaibuildweek.genaifund.ai/#daily_schedule');
